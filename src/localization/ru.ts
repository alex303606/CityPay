export const ruTranslation = {
  translation: {
    ...
    osago: {
      title: 'ОСАГО',
      subTitle:
        'Страховая компания возместит за вас ущерб, который вы нанесли кому-то в результате ДТП.',
      ...
      statementScreen: {
        ...
        IRead: 'Я согласен и принимаю ',
        rules: 'правила',
        rulesTitle: 'Правила',
        conditionsTitle: 'Условия страхования',
        and: ' и ',
        conditions: 'и условия',
        registration: 'страхованияи подтверждаю корректность указанных данных',
      ...
      documentsScreen: {
        ...
        subTitle:
          'Изображения должны быть чётким, текст должен легко читаться. В случае если данные с изображений будут нечитаемы, заявка будет аннулирована.',
      ...
      infoPaymentScreen: {
        ...
        amountInsurance: 'Стоимость полиса:',
        more: 'Подробнее',
        status: 'Статус:',
        totalInformation: 'Общие данные',
